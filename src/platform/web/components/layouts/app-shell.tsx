...
const navItems = [
  ...
  { href: "/company", label: "Company", icon: BarChart3 },
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden">
      ...
      <header className="flex h-14 shrink-0 items-center bg-sidebar px-4">
        {/* Logo */}
        <Link href="/routes">
          <img src="/visor-logo-text-black.svg" alt={brand.name} className="h-6 dark:hidden" />
          <img src="/visor-logo-text-white.svg" alt={brand.name} className="h-6 hidden dark:block" />
        </Link>
