      ...
      <div className="absolute top-4 right-4 z-10 max-h-[calc(100%-2rem)] overflow-y-auto bg-background border rounded-lg px-5 py-4 text-base space-y-3 min-w-[300px]">
        ...
        {mapMode === 'network' ? (
          <>
            ...
            <p className="font-semibold text-base pt-2 border-t border-border/50">Tiers</p>
            <p className="text-sm text-muted-foreground/60 -mt-2">Composite score grouped by percentile band</p>
            {([
